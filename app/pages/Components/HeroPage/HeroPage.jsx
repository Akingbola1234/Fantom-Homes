            ...
            <div className="heropage-details">
                ...
                <div className="heropage-image">
                    ...
                    >
                        <SwiperSlide>
                            <img
                                src={"./Assets/images/heropage-image-new.jpg"}
                                alt=""
                            />
                        </SwiperSlide>
                        <SwiperSlide>
                        ...
                        <SwiperSlide>
                            <img
                                src={"./../Assets/images/heropage-slider-5.jpg"}
                                alt=""
                            />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img
                                src={"./../Assets/images/heropage-slider-6.jpg"}
                                alt=""
                            />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img
                                src={"./../Assets/images/heropage-slider-7.jpg"}
                                alt=""
                            />
                        </SwiperSlide>
